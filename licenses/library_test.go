...
import (
	...
	"github.com/chrismarget-j/go-licenses/internal/third_party/pkgsite/source"
...
func TestLibraries(t *testing.T) {
	...
	for _, test := range []struct {
	...
	}{
		{
			...
			importPath: "github.com/chrismarget-j/go-licenses/licenses/testdata/direct",
			wantLibs:   []wantedLibInfo{directLibInfo, indirectLibInfo},
		},
		{
			desc:       "Detects transitive dependency",
			importPath: "github.com/chrismarget-j/go-licenses/licenses/testdata",
		...
		},
		{
			...
			importPath: "github.com/chrismarget-j/go-licenses/licenses/testdata",
			ignore: []string{
				"github.com/chrismarget-j/go-licenses/licenses/testdata/direct",
			},
			wantLibs: []wantedLibInfo{testdataLibInfo, indirectLibInfo},
		},
		{
			desc:         "Detects the dependencies only imported in testing code",
			importPath:   "github.com/chrismarget-j/go-licenses/licenses/testdata/testlib",
			includeTests: true,
			wantLibs: []wantedLibInfo{
				indirectLibInfo,
				{
					Name:        "github.com/chrismarget-j/go-licenses/licenses/testdata/testlib",
					LicenseFile: wd + "/testdata/LICENSE",
					Licenses:    classifier.licenses["testdata/LICENSE"],
				},
			},
		...
		},
		{
			...
			importPath: "github.com/chrismarget-j/go-licenses/licenses/testdata/tags",
			goflags:    "-tags=tags",
			wantLibs: []wantedLibInfo{
				indirectLibInfo,
				{
					Name:        "github.com/chrismarget-j/go-licenses/licenses/testdata/tags",
					LicenseFile: wd + "/testdata/LICENSE",
					Licenses:    classifier.licenses["testdata/LICENSE"],
				},
			},
